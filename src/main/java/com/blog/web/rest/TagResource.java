...
/**
 * REST controller for managing {@link com.blog.domain.Tag}.
 */
@RestController
@RequestMapping("/api")
public class TagResource {
    ...
    public ResponseEntity<TagDTO> updateTag(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tagDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<TagDTO> partialUpdateTag(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, tagDTO.getId()));
    }
