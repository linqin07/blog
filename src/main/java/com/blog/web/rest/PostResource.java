...
/**
 * REST controller for managing {@link com.blog.domain.Post}.
 */
@RestController
@RequestMapping("/api")
public class PostResource {
    ...
    public ResponseEntity<PostDTO> updatePost(
        ...
        return ResponseEntity
            .ok()
            .headers(HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, postDTO.getId()))
            .body(result);
    }
    ...
    public ResponseEntity<PostDTO> partialUpdatePost(
        ...
        return ResponseUtil.wrapOrNotFound(result, HeaderUtil.createEntityUpdateAlert(applicationName, true, ENTITY_NAME, postDTO.getId()));
    }
